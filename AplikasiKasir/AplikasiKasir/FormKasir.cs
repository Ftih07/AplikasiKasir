...
namespace AplikasiKasir
{
    public partial class FormKasir : Form
    {
        ...
        private void UpdateSubtotalMakanan()
        {
            ...
            int jumlahMakanan = (int)SatuanMakanan.Value;
        ...
        private void UpdateSubtotalMinuman()
        {
            ...
            int jumlahMinuman = (int)SatuanMinuman.Value;
        ...
        private void SubTotalMakanan_TextChanged(object sender, EventArgs e)
        {

        }

        private void SubTotalMinuman_TextChanged(object sender, EventArgs e)
        {
